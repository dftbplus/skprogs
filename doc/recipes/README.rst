...
The `docs/` folder contains the source of the SkProgs recipes book. The content
is currently rendered on `skprogs.readthedocs.io
<https://skprogs.readthedocs.io>`_. You can also render it locally by
